...
public class UsuarioPage extends PageObject {
    ...
    public static final Target SEGUNDO_TV = Target.the("SEGUNDO TV SELECCIONADO").locatedBy("//*[@id=\"search\"]/div[1]/div[1]/div/span[1]/div[1]/div[2]/div/div/span/div/div/div/div[1]/div/div[2]/div/span/a/div/img");

    public static final Target BOTON_CARRITO = Target.the("BOTON AGREGAR CARRITO").locatedBy("//*[@id=\"add-to-cart-button\"]");
